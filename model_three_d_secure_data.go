...
var _ MappedNullable = &ThreeDSecureData{}
...
type _ThreeDSecureData ThreeDSecureData
...
func (o *ThreeDSecureData) UnmarshalJSON(data []byte) (err error) {
	...
	varThreeDSecureData := _ThreeDSecureData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varThreeDSecureData)

	if err != nil {
		return err
	}

	*o = ThreeDSecureData(varThreeDSecureData)
