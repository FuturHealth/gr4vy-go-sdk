...
// checks if the ShippingDetailUpdateRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShippingDetailUpdateRequest{}
...
func (o ShippingDetailUpdateRequest) ToMap() (map[string]interface{}, error) {
