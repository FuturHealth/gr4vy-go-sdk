...
// checks if the Error409DuplicateRecord type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Error409DuplicateRecord{}
...
func (o Error409DuplicateRecord) ToMap() (map[string]interface{}, error) {
