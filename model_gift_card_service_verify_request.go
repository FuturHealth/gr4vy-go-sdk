...
// checks if the GiftCardServiceVerifyRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GiftCardServiceVerifyRequest{}
...
type GiftCardServiceVerifyRequest struct {
	...
	Fields []GiftCardServiceVerifyRequestFieldsInner `json:"fields"`
}

type _GiftCardServiceVerifyRequest GiftCardServiceVerifyRequest
...
func (o *GiftCardServiceVerifyRequest) GetFields() []GiftCardServiceVerifyRequestFieldsInner {
	if o == nil {
		var ret []GiftCardServiceVerifyRequestFieldsInner
		return ret
	}
...
func (o GiftCardServiceVerifyRequest) ToMap() (map[string]interface{}, error) {
...
func (o *GiftCardServiceVerifyRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varGiftCardServiceVerifyRequest := _GiftCardServiceVerifyRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGiftCardServiceVerifyRequest)

	if err != nil {
		return err
	}

	*o = GiftCardServiceVerifyRequest(varGiftCardServiceVerifyRequest)
