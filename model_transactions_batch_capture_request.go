...
// checks if the TransactionsBatchCaptureRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionsBatchCaptureRequest{}
...
type _TransactionsBatchCaptureRequest TransactionsBatchCaptureRequest
...
func (o TransactionsBatchCaptureRequest) ToMap() (map[string]interface{}, error) {
...
func (o *TransactionsBatchCaptureRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varTransactionsBatchCaptureRequest := _TransactionsBatchCaptureRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTransactionsBatchCaptureRequest)

	if err != nil {
		return err
	}

	*o = TransactionsBatchCaptureRequest(varTransactionsBatchCaptureRequest)
