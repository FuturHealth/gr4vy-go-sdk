...
// checks if the TransactionsReportSpecParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionsReportSpecParams{}
...
func (o TransactionsReportSpecParams) ToMap() (map[string]interface{}, error) {
