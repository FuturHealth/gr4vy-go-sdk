...
// checks if the TransactionNetworkTokenGooglePayRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionNetworkTokenGooglePayRequest{}
...
type _TransactionNetworkTokenGooglePayRequest TransactionNetworkTokenGooglePayRequest
...
func (o TransactionNetworkTokenGooglePayRequest) ToMap() (map[string]interface{}, error) {
...
func (o *TransactionNetworkTokenGooglePayRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varTransactionNetworkTokenGooglePayRequest := _TransactionNetworkTokenGooglePayRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTransactionNetworkTokenGooglePayRequest)

	if err != nil {
		return err
	}

	*o = TransactionNetworkTokenGooglePayRequest(varTransactionNetworkTokenGooglePayRequest)
