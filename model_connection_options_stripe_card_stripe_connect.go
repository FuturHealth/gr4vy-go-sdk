...
// checks if the ConnectionOptionsStripeCardStripeConnect type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectionOptionsStripeCardStripeConnect{}
...
func (o *ConnectionOptionsStripeCardStripeConnect) GetStripeAccount() string {
	if o == nil || IsNil(o.StripeAccount.Get()) {
		var ret string
		return ret
	}
...
func (o *ConnectionOptionsStripeCardStripeConnect) GetApplicationFeeAmount() float32 {
	if o == nil || IsNil(o.ApplicationFeeAmount.Get()) {
		var ret float32
		return ret
	}
...
func (o ConnectionOptionsStripeCardStripeConnect) ToMap() (map[string]interface{}, error) {
