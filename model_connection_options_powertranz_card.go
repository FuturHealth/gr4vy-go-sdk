...
// checks if the ConnectionOptionsPowertranzCard type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectionOptionsPowertranzCard{}
...
func (o *ConnectionOptionsPowertranzCard) GetSkipThreeDSecure() bool {
	if o == nil || IsNil(o.SkipThreeDSecure) {
		var ret bool
		return ret
	}
...
func (o ConnectionOptionsPowertranzCard) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.SkipThreeDSecure) {
