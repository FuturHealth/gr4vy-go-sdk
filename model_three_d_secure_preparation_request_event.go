...
// checks if the ThreeDSecurePreparationRequestEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ThreeDSecurePreparationRequestEvent{}
...
func (o ThreeDSecurePreparationRequestEvent) ToMap() (map[string]interface{}, error) {
