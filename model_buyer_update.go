...
// checks if the BuyerUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BuyerUpdate{}
...
func (o BuyerUpdate) ToMap() (map[string]interface{}, error) {
