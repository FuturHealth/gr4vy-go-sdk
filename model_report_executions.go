...
// checks if the ReportExecutions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportExecutions{}
...
func (o ReportExecutions) ToMap() (map[string]interface{}, error) {
