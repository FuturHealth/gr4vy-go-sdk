...
// checks if the PaymentServiceToken type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentServiceToken{}
...
func (o PaymentServiceToken) ToMap() (map[string]interface{}, error) {
