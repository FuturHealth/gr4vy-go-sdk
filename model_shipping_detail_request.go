...
// checks if the ShippingDetailRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShippingDetailRequest{}
...
func (o ShippingDetailRequest) ToMap() (map[string]interface{}, error) {
