...
// checks if the TransactionGiftCardStoredRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionGiftCardStoredRequest{}
...
type _TransactionGiftCardStoredRequest TransactionGiftCardStoredRequest
...
func (o TransactionGiftCardStoredRequest) ToMap() (map[string]interface{}, error) {
...
func (o *TransactionGiftCardStoredRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varTransactionGiftCardStoredRequest := _TransactionGiftCardStoredRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTransactionGiftCardStoredRequest)

	if err != nil {
		return err
	}

	*o = TransactionGiftCardStoredRequest(varTransactionGiftCardStoredRequest)
