...
// checks if the ThreeDSecureV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ThreeDSecureV2{}
...
type ThreeDSecureV2 struct {
	...
	Eci NullableString `json:"eci,omitempty" validate:"regexp=^0?\\\\d$"`
...
func (o *ThreeDSecureV2) GetDirectoryResponse() string {
	if o == nil || IsNil(o.DirectoryResponse.Get()) {
		var ret string
		return ret
	}
...
func (o ThreeDSecureV2) ToMap() (map[string]interface{}, error) {
