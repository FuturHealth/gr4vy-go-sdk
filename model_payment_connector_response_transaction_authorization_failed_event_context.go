...
// checks if the PaymentConnectorResponseTransactionAuthorizationFailedEventContext type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentConnectorResponseTransactionAuthorizationFailedEventContext{}
...
func (o PaymentConnectorResponseTransactionAuthorizationFailedEventContext) ToMap() (map[string]interface{}, error) {
