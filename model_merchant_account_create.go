...
// checks if the MerchantAccountCreate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantAccountCreate{}
...
func (o *MerchantAccountCreate) GetOutboundWebhookUrl() string {
	if o == nil || IsNil(o.OutboundWebhookUrl.Get()) {
		var ret string
		return ret
	}
...
func (o *MerchantAccountCreate) GetOutboundWebhookUsername() string {
	if o == nil || IsNil(o.OutboundWebhookUsername.Get()) {
		var ret string
		return ret
	}
...
func (o *MerchantAccountCreate) GetOutboundWebhookPassword() string {
	if o == nil || IsNil(o.OutboundWebhookPassword.Get()) {
		var ret string
		return ret
	}
...
func (o *MerchantAccountCreate) GetVisaNetworkTokensRequestorId() string {
	if o == nil || IsNil(o.VisaNetworkTokensRequestorId.Get()) {
		var ret string
		return ret
	}
...
func (o *MerchantAccountCreate) GetVisaNetworkTokensAppId() string {
	if o == nil || IsNil(o.VisaNetworkTokensAppId.Get()) {
		var ret string
		return ret
	}
...
func (o *MerchantAccountCreate) GetAmexNetworkTokensRequestorId() string {
	if o == nil || IsNil(o.AmexNetworkTokensRequestorId.Get()) {
		var ret string
		return ret
	}
...
func (o *MerchantAccountCreate) GetAmexNetworkTokensAppId() string {
	if o == nil || IsNil(o.AmexNetworkTokensAppId.Get()) {
		var ret string
		return ret
	}
...
func (o *MerchantAccountCreate) GetMastercardNetworkTokensRequestorId() string {
	if o == nil || IsNil(o.MastercardNetworkTokensRequestorId.Get()) {
		var ret string
		return ret
	}
...
func (o *MerchantAccountCreate) GetMastercardNetworkTokensAppId() string {
	if o == nil || IsNil(o.MastercardNetworkTokensAppId.Get()) {
		var ret string
		return ret
	}
...
func (o *MerchantAccountCreate) GetLoonClientKey() string {
	if o == nil || IsNil(o.LoonClientKey.Get()) {
		var ret string
		return ret
	}
...
func (o *MerchantAccountCreate) GetLoonSecretKey() string {
	if o == nil || IsNil(o.LoonSecretKey.Get()) {
		var ret string
		return ret
	}
...
func (o *MerchantAccountCreate) GetLoonAcceptedSchemesOk() ([]string, bool) {
	if o == nil || IsNil(o.LoonAcceptedSchemes) {
		return nil, false
	}
...
func (o *MerchantAccountCreate) GetOverCaptureAmount() float32 {
	if o == nil || IsNil(o.OverCaptureAmount.Get()) {
		var ret float32
		return ret
	}
...
func (o *MerchantAccountCreate) GetOverCapturePercentage() float32 {
	if o == nil || IsNil(o.OverCapturePercentage.Get()) {
		var ret float32
		return ret
	}
...
func (o MerchantAccountCreate) ToMap() (map[string]interface{}, error) {
