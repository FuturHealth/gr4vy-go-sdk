...
// checks if the TransactionRefundAllRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionRefundAllRequest{}
...
func (o TransactionRefundAllRequest) ToMap() (map[string]interface{}, error) {
