...
// checks if the Payouts type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Payouts{}
...
func (o Payouts) ToMap() (map[string]interface{}, error) {
