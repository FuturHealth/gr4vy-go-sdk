...
// checks if the TransactionRetriesReportSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionRetriesReportSpec{}
...
type _TransactionRetriesReportSpec TransactionRetriesReportSpec
...
func (o TransactionRetriesReportSpec) ToMap() (map[string]interface{}, error) {
...
func (o *TransactionRetriesReportSpec) UnmarshalJSON(data []byte) (err error) {
	...
	varTransactionRetriesReportSpec := _TransactionRetriesReportSpec{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTransactionRetriesReportSpec)

	if err != nil {
		return err
	}

	*o = TransactionRetriesReportSpec(varTransactionRetriesReportSpec)
