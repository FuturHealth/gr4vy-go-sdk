...
// checks if the ThreeDSecureSuccessEventContext type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ThreeDSecureSuccessEventContext{}
...
func (o *ThreeDSecureSuccessEventContext) GetDirectoryTransactionId() string {
	if o == nil || IsNil(o.DirectoryTransactionId.Get()) {
		var ret string
		return ret
	}
...
func (o ThreeDSecureSuccessEventContext) ToMap() (map[string]interface{}, error) {
