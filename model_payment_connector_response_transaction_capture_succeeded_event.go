...
// checks if the PaymentConnectorResponseTransactionCaptureSucceededEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentConnectorResponseTransactionCaptureSucceededEvent{}
...
func (o PaymentConnectorResponseTransactionCaptureSucceededEvent) ToMap() (map[string]interface{}, error) {
