...
// checks if the RequiredFieldsAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RequiredFieldsAddress{}
...
func (o *RequiredFieldsAddress) GetHouseNumberOrName() bool {
	if o == nil || IsNil(o.HouseNumberOrName) {
		var ret bool
		return ret
	}
...
func (o RequiredFieldsAddress) ToMap() (map[string]interface{}, error) {
