...
// checks if the AdditionalIdentifiers type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdditionalIdentifiers{}
...
type _AdditionalIdentifiers AdditionalIdentifiers
...
func (o *AdditionalIdentifiers) GetPaymentServiceAuthorizationId() string {
	if o == nil || IsNil(o.PaymentServiceAuthorizationId.Get()) {
		var ret string
		return ret
	}
...
func (o *AdditionalIdentifiers) GetPaymentServiceCaptureId() string {
	if o == nil || IsNil(o.PaymentServiceCaptureId.Get()) {
		var ret string
		return ret
	}
...
func (o *AdditionalIdentifiers) GetPaymentServiceProcessorId() string {
	if o == nil || IsNil(o.PaymentServiceProcessorId.Get()) {
		var ret string
		return ret
	}
...
func (o AdditionalIdentifiers) ToMap() (map[string]interface{}, error) {
...
func (o *AdditionalIdentifiers) UnmarshalJSON(data []byte) (err error) {
	varAdditionalIdentifiers := _AdditionalIdentifiers{}

	err = json.Unmarshal(data, &varAdditionalIdentifiers)

	if err != nil {
		return err
	}

	*o = AdditionalIdentifiers(varAdditionalIdentifiers)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "payment_service_authorization_id")
		delete(additionalProperties, "payment_service_capture_id")
		delete(additionalProperties, "payment_service_processor_id")
