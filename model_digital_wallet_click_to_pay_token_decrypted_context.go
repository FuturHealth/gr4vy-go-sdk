...
// checks if the DigitalWalletClickToPayTokenDecryptedContext type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DigitalWalletClickToPayTokenDecryptedContext{}
...
func (o *DigitalWalletClickToPayTokenDecryptedContext) GetMerchantTransactionId() string {
	if o == nil || IsNil(o.MerchantTransactionId) {
		var ret string
		return ret
	}
...
func (o *DigitalWalletClickToPayTokenDecryptedContext) GetBillingLine1() string {
	if o == nil || IsNil(o.BillingLine1.Get()) {
		var ret string
		return ret
	}
...
func (o *DigitalWalletClickToPayTokenDecryptedContext) GetBillingLine2() string {
	if o == nil || IsNil(o.BillingLine2.Get()) {
		var ret string
		return ret
	}
...
func (o *DigitalWalletClickToPayTokenDecryptedContext) GetBillingState() string {
	if o == nil || IsNil(o.BillingState.Get()) {
		var ret string
		return ret
	}
...
func (o *DigitalWalletClickToPayTokenDecryptedContext) GetBillingZip() string {
	if o == nil || IsNil(o.BillingZip.Get()) {
		var ret string
		return ret
	}
...
func (o *DigitalWalletClickToPayTokenDecryptedContext) GetBillingCountryCode() string {
	if o == nil || IsNil(o.BillingCountryCode.Get()) {
		var ret string
		return ret
	}
...
func (o DigitalWalletClickToPayTokenDecryptedContext) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.CorrelationId) {
		toSerialize["correlation_id"] = o.CorrelationId
	}
	if !IsNil(o.MerchantTransactionId) {
