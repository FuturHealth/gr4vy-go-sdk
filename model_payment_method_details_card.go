...
// checks if the PaymentMethodDetailsCard type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentMethodDetailsCard{}
...
func (o PaymentMethodDetailsCard) ToMap() (map[string]interface{}, error) {
