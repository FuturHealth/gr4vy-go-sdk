...
// checks if the GooglePayRequestAssuranceDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GooglePayRequestAssuranceDetails{}
...
func (o *GooglePayRequestAssuranceDetails) GetAccountVerified() bool {
	if o == nil || IsNil(o.AccountVerified.Get()) {
		var ret bool
		return ret
	}
...
func (o *GooglePayRequestAssuranceDetails) GetCardHolderAuthenticated() bool {
	if o == nil || IsNil(o.CardHolderAuthenticated.Get()) {
		var ret bool
		return ret
	}
...
func (o GooglePayRequestAssuranceDetails) ToMap() (map[string]interface{}, error) {
