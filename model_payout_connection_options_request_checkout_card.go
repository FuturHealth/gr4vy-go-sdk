...
// checks if the PayoutConnectionOptionsRequestCheckoutCard type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PayoutConnectionOptionsRequestCheckoutCard{}
...
func (o *PayoutConnectionOptionsRequestCheckoutCard) GetProcessingChannelId() string {
	if o == nil || IsNil(o.ProcessingChannelId) {
		var ret string
		return ret
	}
...
func (o PayoutConnectionOptionsRequestCheckoutCard) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.SourceId) {
		toSerialize["source_id"] = o.SourceId
	}
	if !IsNil(o.ProcessingChannelId) {
