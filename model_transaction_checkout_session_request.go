...
// checks if the TransactionCheckoutSessionRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionCheckoutSessionRequest{}
...
type _TransactionCheckoutSessionRequest TransactionCheckoutSessionRequest
...
func (o TransactionCheckoutSessionRequest) ToMap() (map[string]interface{}, error) {
...
func (o *TransactionCheckoutSessionRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varTransactionCheckoutSessionRequest := _TransactionCheckoutSessionRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTransactionCheckoutSessionRequest)

	if err != nil {
		return err
	}

	*o = TransactionCheckoutSessionRequest(varTransactionCheckoutSessionRequest)
