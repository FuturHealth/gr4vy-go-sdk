...
// checks if the PaymentOptionsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentOptionsRequest{}
...
type PaymentOptionsRequest struct {
	...
	Locale NullableString `json:"locale,omitempty" validate:"regexp=^[a-z]{2}(?:-[A-Z]{2})?$"`
...
func (o PaymentOptionsRequest) ToMap() (map[string]interface{}, error) {
