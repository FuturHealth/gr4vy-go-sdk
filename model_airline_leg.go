...
// checks if the AirlineLeg type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AirlineLeg{}
...
func (o *AirlineLeg) GetDepartureAt() time.Time {
	if o == nil || IsNil(o.DepartureAt.Get()) {
		var ret time.Time
		return ret
	}
...
func (o *AirlineLeg) GetDepartureCountry() string {
	if o == nil || IsNil(o.DepartureCountry.Get()) {
		var ret string
		return ret
	}
...
func (o *AirlineLeg) GetDepartureCity() string {
	if o == nil || IsNil(o.DepartureCity.Get()) {
		var ret string
		return ret
	}
...
func (o *AirlineLeg) GetDepartureAirport() string {
	if o == nil || IsNil(o.DepartureAirport.Get()) {
		var ret string
		return ret
	}
...
func (o *AirlineLeg) GetArrivalAt() time.Time {
	if o == nil || IsNil(o.ArrivalAt.Get()) {
		var ret time.Time
		return ret
	}
...
func (o *AirlineLeg) GetArrivalCountry() string {
	if o == nil || IsNil(o.ArrivalCountry.Get()) {
		var ret string
		return ret
	}
...
func (o *AirlineLeg) GetArrivalCity() string {
	if o == nil || IsNil(o.ArrivalCity.Get()) {
		var ret string
		return ret
	}
...
func (o *AirlineLeg) GetArrivalAirport() string {
	if o == nil || IsNil(o.ArrivalAirport.Get()) {
		var ret string
		return ret
	}
...
func (o *AirlineLeg) GetFareBasisCode() string {
	if o == nil || IsNil(o.FareBasisCode.Get()) {
		var ret string
		return ret
	}
...
func (o *AirlineLeg) GetFlightClass() string {
	if o == nil || IsNil(o.FlightClass.Get()) {
		var ret string
		return ret
	}
...
func (o *AirlineLeg) GetCouponNumber() string {
	if o == nil || IsNil(o.CouponNumber.Get()) {
		var ret string
		return ret
	}
...
func (o *AirlineLeg) GetFareAmount() int32 {
	if o == nil || IsNil(o.FareAmount.Get()) {
		var ret int32
		return ret
	}
...
func (o *AirlineLeg) GetDepartureTaxAmount() int32 {
	if o == nil || IsNil(o.DepartureTaxAmount.Get()) {
		var ret int32
		return ret
	}
...
func (o AirlineLeg) ToMap() (map[string]interface{}, error) {
