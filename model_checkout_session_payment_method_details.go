...
// checks if the CheckoutSessionPaymentMethodDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CheckoutSessionPaymentMethodDetails{}
...
func (o CheckoutSessionPaymentMethodDetails) ToMap() (map[string]interface{}, error) {
