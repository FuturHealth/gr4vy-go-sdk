...
// checks if the MerchantProfileSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantProfileSummary{}
...
func (o *MerchantProfileSummary) GetMastercard() MerchantProfileSchemeSummary {
	if o == nil || IsNil(o.Mastercard.Get()) {
		var ret MerchantProfileSchemeSummary
		return ret
	}
...
func (o MerchantProfileSummary) ToMap() (map[string]interface{}, error) {
