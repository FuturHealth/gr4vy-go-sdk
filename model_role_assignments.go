...
// checks if the RoleAssignments type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoleAssignments{}
...
func (o RoleAssignments) ToMap() (map[string]interface{}, error) {
