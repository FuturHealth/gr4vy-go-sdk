...
// checks if the NetworkTokenCryptogramProvisionFailedContext type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkTokenCryptogramProvisionFailedContext{}
...
func (o NetworkTokenCryptogramProvisionFailedContext) ToMap() (map[string]interface{}, error) {
