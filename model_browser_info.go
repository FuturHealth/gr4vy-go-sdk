...
func (o BrowserInfo) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AcceptHeader) {
		toSerialize["accept_header"] = o.AcceptHeader
	}
	return toSerialize, nil
}

func (o *BrowserInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varBrowserInfo := _BrowserInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBrowserInfo)

	if err != nil {
		return err
	}

	*o = BrowserInfo(varBrowserInfo)
