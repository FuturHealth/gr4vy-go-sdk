...
// checks if the GiftCardRedemption type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GiftCardRedemption{}
...
func (o *GiftCardRedemption) GetGiftCardServiceRedemptionId() string {
	if o == nil || IsNil(o.GiftCardServiceRedemptionId.Get()) {
		var ret string
		return ret
	}
...
func (o *GiftCardRedemption) GetRawErrorCode() string {
	if o == nil || IsNil(o.RawErrorCode.Get()) {
		var ret string
		return ret
	}
...
func (o *GiftCardRedemption) GetRawErrorMessage() string {
	if o == nil || IsNil(o.RawErrorMessage.Get()) {
		var ret string
		return ret
	}
...
func (o GiftCardRedemption) ToMap() (map[string]interface{}, error) {
