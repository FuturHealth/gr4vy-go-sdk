...
func (o *TransactionRequest) GetAntiFraudFingerprint() string {
	if o == nil || IsNil(o.AntiFraudFingerprint.Get()) {
		var ret string
		return ret
	}
...
func (o *TransactionRequest) GetBrowserInfo() BrowserInfo {
	if o == nil || IsNil(o.BrowserInfo.Get()) {
		var ret BrowserInfo
		return ret
	}
...
func (o *TransactionRequest) GetPreviousSchemeTransactionId() string {
	if o == nil || IsNil(o.PreviousSchemeTransactionId.Get()) {
		var ret string
		return ret
	}
...
func (o *TransactionRequest) GetShippingDetailsId() string {
	if o == nil || IsNil(o.ShippingDetailsId.Get()) {
		var ret string
		return ret
	}
...
func (o *TransactionRequest) GetThreeDSecureData() ThreeDSecureDataV1V2 {
	if o == nil || IsNil(o.ThreeDSecureData) {
...
func (o *TransactionRequest) GetPaymentServiceId() string {
	if o == nil || IsNil(o.PaymentServiceId.Get()) {
		var ret string
		return ret
	}
