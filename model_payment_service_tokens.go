...
// checks if the PaymentServiceTokens type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentServiceTokens{}
...
func (o PaymentServiceTokens) ToMap() (map[string]interface{}, error) {
