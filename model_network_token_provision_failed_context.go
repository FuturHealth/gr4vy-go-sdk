...
// checks if the NetworkTokenProvisionFailedContext type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkTokenProvisionFailedContext{}
...
func (o NetworkTokenProvisionFailedContext) ToMap() (map[string]interface{}, error) {
