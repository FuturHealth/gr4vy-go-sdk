...
// checks if the DetailedSettlementReportSpecParamsFilters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DetailedSettlementReportSpecParamsFilters{}
...
func (o DetailedSettlementReportSpecParamsFilters) ToMap() (map[string]interface{}, error) {
