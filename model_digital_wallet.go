...
// checks if the DigitalWallet type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DigitalWallet{}
...
func (o *DigitalWallet) GetActiveCertificateCount() int32 {
	if o == nil || IsNil(o.ActiveCertificateCount) {
		var ret int32
		return ret
	}
...
func (o *DigitalWallet) GetPendingCertificateCount() int32 {
	if o == nil || IsNil(o.PendingCertificateCount) {
		var ret int32
		return ret
	}
...
func (o *DigitalWallet) GetExpiredCertificateCount() int32 {
	if o == nil || IsNil(o.ExpiredCertificateCount) {
		var ret int32
		return ret
	}
...
func (o DigitalWallet) ToMap() (map[string]interface{}, error) {
