...
// checks if the GiftCardRedemptionSucceededContext type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GiftCardRedemptionSucceededContext{}
...
func (o GiftCardRedemptionSucceededContext) ToMap() (map[string]interface{}, error) {
