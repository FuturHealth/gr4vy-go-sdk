...
// checks if the NetworkTokenCryptogramProvisionFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkTokenCryptogramProvisionFailed{}
...
func (o NetworkTokenCryptogramProvisionFailed) ToMap() (map[string]interface{}, error) {
