...
// checks if the PaymentMethods type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentMethods{}
...
func (o PaymentMethods) ToMap() (map[string]interface{}, error) {
