...
// checks if the AntiFraudDecisionEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AntiFraudDecisionEvent{}
...
func (o AntiFraudDecisionEvent) ToMap() (map[string]interface{}, error) {
