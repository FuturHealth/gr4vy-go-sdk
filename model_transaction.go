...
func (o *Transaction) GetAdditionalIdentifiers() AdditionalIdentifiers {
	if o == nil || IsNil(o.AdditionalIdentifiers) {
...
func (o *Transaction) GetAuthResponseCode() string {
	if o == nil || IsNil(o.AuthResponseCode.Get()) {
		var ret string
		return ret
	}
...
func (o *Transaction) GetAuthorizedAmount() int32 {
	if o == nil || IsNil(o.AuthorizedAmount) {
		var ret int32
		return ret
	}
...
func (o *Transaction) GetApprovalExpiresAt() time.Time {
	if o == nil || IsNil(o.ApprovalExpiresAt.Get()) {
		var ret time.Time
		return ret
	}
...
func (o *Transaction) GetGiftCardService() GiftCardServiceSnapshot {
	if o == nil || IsNil(o.GiftCardService) {
...
func (o *Transaction) GetGiftCardRedemptions() []GiftCardRedemption {
	if o == nil || IsNil(o.GiftCardRedemptions) {
...
func (o *Transaction) GetIntentOutcome() string {
	if o == nil || IsNil(o.IntentOutcome) {
		var ret string
		return ret
	}
...
func (o *Transaction) GetIsSubsequentPayment() bool {
	if o == nil || IsNil(o.IsSubsequentPayment) {
		var ret bool
		return ret
	}
...
func (o *Transaction) GetMerchantInitiated() bool {
	if o == nil || IsNil(o.MerchantInitiated) {
		var ret bool
		return ret
	}
...
func (o *Transaction) GetPaymentService() PaymentServiceSnapshot {
	if o == nil || IsNil(o.PaymentService.Get()) {
...
func (o *Transaction) GetSchemeTransactionId() string {
	if o == nil || IsNil(o.SchemeTransactionId.Get()) {
		var ret string
		return ret
	}
...
func (o *Transaction) GetSettledCurrency() string {
	if o == nil || IsNil(o.SettledCurrency.Get()) {
		var ret string
		return ret
	}
...
func (o Transaction) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AdditionalIdentifiers) {
	...
	if !IsNil(o.GiftCardService) {
		toSerialize["gift_card_service"] = o.GiftCardService
	}
	if !IsNil(o.GiftCardRedemptions) {
	...
	if !IsNil(o.IntentOutcome) {
		toSerialize["intent_outcome"] = o.IntentOutcome
	}
	if !IsNil(o.IsSubsequentPayment) {
