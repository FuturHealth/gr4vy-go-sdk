...
// checks if the ApiLogResponseBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiLogResponseBody{}
...
func (o ApiLogResponseBody) ToMap() (map[string]interface{}, error) {
