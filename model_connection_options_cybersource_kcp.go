...
// checks if the ConnectionOptionsCybersourceKcp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectionOptionsCybersourceKcp{}
...
func (o ConnectionOptionsCybersourceKcp) ToMap() (map[string]interface{}, error) {
