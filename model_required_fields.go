...
// checks if the RequiredFields type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RequiredFields{}
...
func (o RequiredFields) ToMap() (map[string]interface{}, error) {
