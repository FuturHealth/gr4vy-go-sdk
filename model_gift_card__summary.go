...
// checks if the GiftCardSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GiftCardSummary{}
...
func (o *GiftCardSummary) GetBalanceErrorCode() string {
	if o == nil || IsNil(o.BalanceErrorCode.Get()) {
		var ret string
		return ret
	}
...
func (o *GiftCardSummary) GetBalanceRawErrorCode() string {
	if o == nil || IsNil(o.BalanceRawErrorCode.Get()) {
		var ret string
		return ret
	}
...
func (o *GiftCardSummary) GetBalanceRawErrorMessage() string {
	if o == nil || IsNil(o.BalanceRawErrorMessage.Get()) {
		var ret string
		return ret
	}
...
func (o GiftCardSummary) ToMap() (map[string]interface{}, error) {
