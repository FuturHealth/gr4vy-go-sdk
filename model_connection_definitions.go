...
// checks if the ConnectionDefinitions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectionDefinitions{}
...
func (o ConnectionDefinitions) ToMap() (map[string]interface{}, error) {
