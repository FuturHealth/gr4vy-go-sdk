...
// checks if the ConnectionOptionsCybersourceIdeal type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectionOptionsCybersourceIdeal{}
...
func (o *ConnectionOptionsCybersourceIdeal) GetMetaKeyMerchantId() string {
	if o == nil || IsNil(o.MetaKeyMerchantId.Get()) {
		var ret string
		return ret
	}
...
func (o *ConnectionOptionsCybersourceIdeal) GetMerchantDefinedInformation() map[string]string {
	if o == nil || IsNil(o.MerchantDefinedInformation) {
...
func (o *ConnectionOptionsCybersourceIdeal) GetShipToMethod() string {
	if o == nil || IsNil(o.ShipToMethod.Get()) {
		var ret string
		return ret
	}
...
func (o ConnectionOptionsCybersourceIdeal) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if o.MetaKeyMerchantId.IsSet() {
		toSerialize["meta_key_merchant_id"] = o.MetaKeyMerchantId.Get()
	}
	if !IsNil(o.MerchantDefinedInformation) {
