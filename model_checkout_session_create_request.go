...
// checks if the CheckoutSessionCreateRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CheckoutSessionCreateRequest{}
...
func (o CheckoutSessionCreateRequest) ToMap() (map[string]interface{}, error) {
