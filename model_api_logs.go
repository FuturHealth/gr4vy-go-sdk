...
// checks if the ApiLogs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiLogs{}
...
func (o ApiLogs) ToMap() (map[string]interface{}, error) {
