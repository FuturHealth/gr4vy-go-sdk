...
// checks if the GiftCardRefundFailedContext type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GiftCardRefundFailedContext{}
...
func (o GiftCardRefundFailedContext) ToMap() (map[string]interface{}, error) {
