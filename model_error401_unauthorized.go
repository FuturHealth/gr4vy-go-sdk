...
// checks if the Error401Unauthorized type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Error401Unauthorized{}
...
func (o Error401Unauthorized) ToMap() (map[string]interface{}, error) {
