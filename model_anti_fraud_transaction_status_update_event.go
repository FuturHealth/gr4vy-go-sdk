...
// checks if the AntiFraudTransactionStatusUpdateEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AntiFraudTransactionStatusUpdateEvent{}
...
func (o AntiFraudTransactionStatusUpdateEvent) ToMap() (map[string]interface{}, error) {
