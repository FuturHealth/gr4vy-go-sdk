...
func (o *Airline) GetPassengerNameRecord() string {
	if o == nil || IsNil(o.PassengerNameRecord.Get()) {
		var ret string
		return ret
	}
...
func (o *Airline) GetBookingCode() string {
	if o == nil || IsNil(o.BookingCode.Get()) {
		var ret string
		return ret
	}
...
func (o *Airline) GetTicketDeliveryMethod() string {
	if o == nil || IsNil(o.TicketDeliveryMethod.Get()) {
		var ret string
		return ret
	}
...
func (o *Airline) GetIssuedAddress() string {
	if o == nil || IsNil(o.IssuedAddress.Get()) {
		var ret string
		return ret
	}
...
func (o *Airline) GetTravelAgencyCode() string {
	if o == nil || IsNil(o.TravelAgencyCode.Get()) {
		var ret string
		return ret
	}
...
func (o *Airline) GetTravelAgencyName() string {
	if o == nil || IsNil(o.TravelAgencyName.Get()) {
		var ret string
		return ret
	}
...
func (o *Airline) GetTravelAgencyInvoiceNumber() string {
	if o == nil || IsNil(o.TravelAgencyInvoiceNumber.Get()) {
		var ret string
		return ret
	}
...
func (o *Airline) GetTravelAgencyPlanName() string {
	if o == nil || IsNil(o.TravelAgencyPlanName.Get()) {
		var ret string
		return ret
	}
...
func (o *Airline) GetRestrictedTicket() bool {
	if o == nil || IsNil(o.RestrictedTicket.Get()) {
		var ret bool
		return ret
	}
...
func (o *Airline) GetIssuingCarrierCode() string {
	if o == nil || IsNil(o.IssuingCarrierCode.Get()) {
		var ret string
		return ret
	}
...
func (o *Airline) GetReservationSystem() string {
	if o == nil || IsNil(o.ReservationSystem.Get()) {
		var ret string
		return ret
	}
