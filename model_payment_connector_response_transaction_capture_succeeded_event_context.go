...
// checks if the PaymentConnectorResponseTransactionCaptureSucceededEventContext type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentConnectorResponseTransactionCaptureSucceededEventContext{}
...
func (o PaymentConnectorResponseTransactionCaptureSucceededEventContext) ToMap() (map[string]interface{}, error) {
