...
// checks if the GiftCards type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GiftCards{}
...
func (o GiftCards) ToMap() (map[string]interface{}, error) {
