...
// checks if the GiftCardRedemptionSucceeded type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GiftCardRedemptionSucceeded{}
...
func (o GiftCardRedemptionSucceeded) ToMap() (map[string]interface{}, error) {
