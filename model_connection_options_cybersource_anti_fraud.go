...
// checks if the ConnectionOptionsCybersourceAntiFraud type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectionOptionsCybersourceAntiFraud{}
...
func (o *ConnectionOptionsCybersourceAntiFraud) GetMerchantDefinedData() map[string]string {
	if o == nil || IsNil(o.MerchantDefinedData) {
...
func (o ConnectionOptionsCybersourceAntiFraud) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if o.MetaKeyMerchantId.IsSet() {
		toSerialize["meta_key_merchant_id"] = o.MetaKeyMerchantId.Get()
	}
	if !IsNil(o.MerchantDefinedData) {
