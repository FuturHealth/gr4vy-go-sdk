...
// checks if the ThreeDSecureResultRequestEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ThreeDSecureResultRequestEvent{}
...
func (o ThreeDSecureResultRequestEvent) ToMap() (map[string]interface{}, error) {
