...
// checks if the ThreeDSecureAuthenticationRequestEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ThreeDSecureAuthenticationRequestEvent{}
...
func (o ThreeDSecureAuthenticationRequestEvent) ToMap() (map[string]interface{}, error) {
