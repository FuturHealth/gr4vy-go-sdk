...
// checks if the TransactionSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionSummary{}
...
func (o TransactionSummary) ToMap() (map[string]interface{}, error) {
