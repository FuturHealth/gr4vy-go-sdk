...
// checks if the ConnectionOptionsForterAntiFraud type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectionOptionsForterAntiFraud{}
...
type ConnectionOptionsForterAntiFraud struct {
	...
	CartItems []ConnectionOptionsForterAntiFraudCartItemsInner `json:"cart_items,omitempty"`
...
func (o *ConnectionOptionsForterAntiFraud) GetCartItems() []ConnectionOptionsForterAntiFraudCartItemsInner {
	if o == nil || IsNil(o.CartItems) {
		var ret []ConnectionOptionsForterAntiFraudCartItemsInner
		return ret
	}
	return o.CartItems
}
...
// SetCartItems gets a reference to the given []ConnectionOptionsForterAntiFraudCartItemsInner and assigns it to the CartItems field.
...
func (o ConnectionOptionsForterAntiFraud) ToMap() (map[string]interface{}, error) {
