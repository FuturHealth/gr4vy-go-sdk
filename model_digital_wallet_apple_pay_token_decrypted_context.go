...
// checks if the DigitalWalletApplePayTokenDecryptedContext type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DigitalWalletApplePayTokenDecryptedContext{}
...
func (o *DigitalWalletApplePayTokenDecryptedContext) GetApplicationData() string {
	if o == nil || IsNil(o.ApplicationData.Get()) {
		var ret string
		return ret
	}
...
func (o *DigitalWalletApplePayTokenDecryptedContext) GetDeviceManufacturerIdentifier() string {
	if o == nil || IsNil(o.DeviceManufacturerIdentifier) {
		var ret string
		return ret
	}
...
func (o *DigitalWalletApplePayTokenDecryptedContext) GetPaymentDataType() string {
	if o == nil || IsNil(o.PaymentDataType) {
		var ret string
		return ret
	}
...
func (o *DigitalWalletApplePayTokenDecryptedContext) GetMerchantTokenIdentifier() string {
	if o == nil || IsNil(o.MerchantTokenIdentifier.Get()) {
		var ret string
		return ret
	}
...
func (o *DigitalWalletApplePayTokenDecryptedContext) GetCardExpirationDate() string {
	if o == nil || IsNil(o.CardExpirationDate.Get()) {
		var ret string
		return ret
	}
...
func (o DigitalWalletApplePayTokenDecryptedContext) ToMap() (map[string]interface{}, error) {
