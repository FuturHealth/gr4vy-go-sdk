...
// checks if the ThreeDSecureSuccessEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ThreeDSecureSuccessEvent{}
...
func (o ThreeDSecureSuccessEvent) ToMap() (map[string]interface{}, error) {
