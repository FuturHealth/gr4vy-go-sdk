...
// checks if the ShippingDetail type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShippingDetail{}
...
func (o ShippingDetail) ToMap() (map[string]interface{}, error) {
