...
// checks if the TransactionCardRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionCardRequest{}
...
type _TransactionCardRequest TransactionCardRequest
...
func (o TransactionCardRequest) ToMap() (map[string]interface{}, error) {
...
func (o *TransactionCardRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varTransactionCardRequest := _TransactionCardRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTransactionCardRequest)

	if err != nil {
		return err
	}

	*o = TransactionCardRequest(varTransactionCardRequest)
