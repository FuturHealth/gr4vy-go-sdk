...
// checks if the PaymentConnectorResponseTransactionVoidFailedEventContext type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentConnectorResponseTransactionVoidFailedEventContext{}
...
func (o PaymentConnectorResponseTransactionVoidFailedEventContext) ToMap() (map[string]interface{}, error) {
