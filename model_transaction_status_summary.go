...
// checks if the TransactionStatusSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionStatusSummary{}
...
func (o TransactionStatusSummary) ToMap() (map[string]interface{}, error) {
