...
// checks if the AirlinePassenger type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AirlinePassenger{}
...
func (o *AirlinePassenger) GetFrequentFlyerNumber() string {
	if o == nil || IsNil(o.FrequentFlyerNumber.Get()) {
		var ret string
		return ret
	}
...
func (o AirlinePassenger) ToMap() (map[string]interface{}, error) {
