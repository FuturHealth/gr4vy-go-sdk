...
// checks if the Error429TooManyRequests type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Error429TooManyRequests{}
...
func (o Error429TooManyRequests) ToMap() (map[string]interface{}, error) {
