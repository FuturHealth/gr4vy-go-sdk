...
// checks if the Buyers type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Buyers{}
...
func (o Buyers) ToMap() (map[string]interface{}, error) {
