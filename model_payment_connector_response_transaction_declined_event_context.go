...
// checks if the PaymentConnectorResponseTransactionDeclinedEventContext type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentConnectorResponseTransactionDeclinedEventContext{}
...
func (o PaymentConnectorResponseTransactionDeclinedEventContext) ToMap() (map[string]interface{}, error) {
