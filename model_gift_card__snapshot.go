...
// checks if the GiftCardSnapshot type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GiftCardSnapshot{}
...
func (o GiftCardSnapshot) ToMap() (map[string]interface{}, error) {
