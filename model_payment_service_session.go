...
// checks if the PaymentServiceSession type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentServiceSession{}
...
func (o PaymentServiceSession) ToMap() (map[string]interface{}, error) {
