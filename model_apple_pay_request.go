...
// checks if the ApplePayRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplePayRequest{}
...
type _ApplePayRequest ApplePayRequest
...
func (o ApplePayRequest) ToMap() (map[string]interface{}, error) {
...
func (o *ApplePayRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varApplePayRequest := _ApplePayRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApplePayRequest)

	if err != nil {
		return err
	}

	*o = ApplePayRequest(varApplePayRequest)
