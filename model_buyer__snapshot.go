...
// checks if the BuyerSnapshot type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BuyerSnapshot{}
...
func (o BuyerSnapshot) ToMap() (map[string]interface{}, error) {
