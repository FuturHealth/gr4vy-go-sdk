...
// checks if the ConnectionOptionsStripeCard type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectionOptionsStripeCard{}
...
func (o *ConnectionOptionsStripeCard) GetErrorOnRequiresAction() bool {
	if o == nil || IsNil(o.ErrorOnRequiresAction) {
		var ret bool
		return ret
	}
...
func (o *ConnectionOptionsStripeCard) GetStripeConnect() ConnectionOptionsStripeCardStripeConnect {
	if o == nil || IsNil(o.StripeConnect.Get()) {
...
func (o ConnectionOptionsStripeCard) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ErrorOnRequiresAction) {
