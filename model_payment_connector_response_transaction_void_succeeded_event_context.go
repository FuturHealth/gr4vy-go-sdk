...
// checks if the PaymentConnectorResponseTransactionVoidSucceededEventContext type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentConnectorResponseTransactionVoidSucceededEventContext{}
...
func (o PaymentConnectorResponseTransactionVoidSucceededEventContext) ToMap() (map[string]interface{}, error) {
