...
// checks if the TransactionPaymentMethodRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionPaymentMethodRequest{}
...
type TransactionPaymentMethodRequest struct {
	...
	Number NullableString `json:"number,omitempty" validate:"regexp=^[0-9]{13,19}$"`
	// The expiration date of the card, formatted `MM/YY`. If a card has been previously stored with us this value is optional.
	ExpirationDate NullableString `json:"expiration_date,omitempty" validate:"regexp=^\\\\d\\\\d\\/\\\\d\\\\d$"`
...
func (o *TransactionPaymentMethodRequest) GetAssuranceDetails() GooglePayRequestAssuranceDetails {
	if o == nil || IsNil(o.AssuranceDetails.Get()) {
...
func (o TransactionPaymentMethodRequest) ToMap() (map[string]interface{}, error) {
...
func (o *TransactionPaymentMethodRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varTransactionPaymentMethodRequest := _TransactionPaymentMethodRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTransactionPaymentMethodRequest)

	if err != nil {
		return err
	}

	*o = TransactionPaymentMethodRequest(varTransactionPaymentMethodRequest)
