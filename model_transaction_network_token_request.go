...
// checks if the TransactionNetworkTokenRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionNetworkTokenRequest{}
...
type _TransactionNetworkTokenRequest TransactionNetworkTokenRequest
...
func (o TransactionNetworkTokenRequest) ToMap() (map[string]interface{}, error) {
...
func (o *TransactionNetworkTokenRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varTransactionNetworkTokenRequest := _TransactionNetworkTokenRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTransactionNetworkTokenRequest)

	if err != nil {
		return err
	}

	*o = TransactionNetworkTokenRequest(varTransactionNetworkTokenRequest)
