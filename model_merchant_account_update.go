...
// checks if the MerchantAccountUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantAccountUpdate{}
...
func (o MerchantAccountUpdate) ToMap() (map[string]interface{}, error) {
