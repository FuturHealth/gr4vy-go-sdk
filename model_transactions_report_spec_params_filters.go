...
// checks if the TransactionsReportSpecParamsFilters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionsReportSpecParamsFilters{}
...
func (o *TransactionsReportSpecParamsFilters) GetThreeDSecureStatus() []string {
	if o == nil || IsNil(o.ThreeDSecureStatus) {
		var ret []string
		return ret
	}
...
func (o *TransactionsReportSpecParamsFilters) GetThreeDSecureEci() []string {
	if o == nil || IsNil(o.ThreeDSecureEci) {
		var ret []string
		return ret
	}
...
func (o *TransactionsReportSpecParamsFilters) GetThreeDSecureAuthResp() []string {
	if o == nil || IsNil(o.ThreeDSecureAuthResp) {
		var ret []string
		return ret
	}
...
func (o TransactionsReportSpecParamsFilters) ToMap() (map[string]interface{}, error) {
