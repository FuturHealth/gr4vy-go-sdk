...
// checks if the TransactionHistoryEvents type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionHistoryEvents{}
...
func (o TransactionHistoryEvents) ToMap() (map[string]interface{}, error) {
