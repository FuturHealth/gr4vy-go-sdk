...
// checks if the PaymentConnectorResponseTransactionVoidDeclinedEventContext type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentConnectorResponseTransactionVoidDeclinedEventContext{}
...
func (o PaymentConnectorResponseTransactionVoidDeclinedEventContext) ToMap() (map[string]interface{}, error) {
