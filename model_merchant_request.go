...
// checks if the MerchantRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantRequest{}
...
type _MerchantRequest MerchantRequest
...
func (o MerchantRequest) ToMap() (map[string]interface{}, error) {
...
func (o *MerchantRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varMerchantRequest := _MerchantRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMerchantRequest)

	if err != nil {
		return err
	}

	*o = MerchantRequest(varMerchantRequest)
