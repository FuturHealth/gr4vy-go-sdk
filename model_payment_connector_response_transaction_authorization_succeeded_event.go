...
// checks if the PaymentConnectorResponseTransactionAuthorizationSucceededEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentConnectorResponseTransactionAuthorizationSucceededEvent{}
...
func (o PaymentConnectorResponseTransactionAuthorizationSucceededEvent) ToMap() (map[string]interface{}, error) {
