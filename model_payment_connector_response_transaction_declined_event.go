...
// checks if the PaymentConnectorResponseTransactionDeclinedEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentConnectorResponseTransactionDeclinedEvent{}
...
func (o PaymentConnectorResponseTransactionDeclinedEvent) ToMap() (map[string]interface{}, error) {
