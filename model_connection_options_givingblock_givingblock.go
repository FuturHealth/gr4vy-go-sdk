...
// checks if the ConnectionOptionsGivingblockGivingblock type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectionOptionsGivingblockGivingblock{}
...
func (o *ConnectionOptionsGivingblockGivingblock) GetDefaultCryptocurrency() string {
	if o == nil || IsNil(o.DefaultCryptocurrency) {
		var ret string
		return ret
	}
...
func (o ConnectionOptionsGivingblockGivingblock) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.DefaultCryptocurrency) {
