...
// checks if the TransactionRefundRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionRefundRequest{}
...
func (o TransactionRefundRequest) ToMap() (map[string]interface{}, error) {
