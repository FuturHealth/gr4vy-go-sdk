...
// checks if the GooglePayRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GooglePayRequest{}
...
type _GooglePayRequest GooglePayRequest
...
func (o GooglePayRequest) ToMap() (map[string]interface{}, error) {
...
func (o *GooglePayRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varGooglePayRequest := _GooglePayRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGooglePayRequest)

	if err != nil {
		return err
	}

	*o = GooglePayRequest(varGooglePayRequest)
