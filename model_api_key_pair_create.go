...
// checks if the APIKeyPairCreate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &APIKeyPairCreate{}
...
func (o *APIKeyPairCreate) GetMerchantAccountId() string {
	if o == nil || IsNil(o.MerchantAccountId.Get()) {
		var ret string
		return ret
	}
...
func (o APIKeyPairCreate) ToMap() (map[string]interface{}, error) {
