...
// checks if the ApiLogResponseBodyDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiLogResponseBodyDetails{}
...
func (o ApiLogResponseBodyDetails) ToMap() (map[string]interface{}, error) {
