...
// checks if the GiftCardBalancesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GiftCardBalancesRequest{}
...
func (o GiftCardBalancesRequest) ToMap() (map[string]interface{}, error) {
