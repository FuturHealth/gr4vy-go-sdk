...
// checks if the GiftCardsSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GiftCardsSummary{}
...
func (o GiftCardsSummary) ToMap() (map[string]interface{}, error) {
