...
// checks if the BillingDetailsUpdateRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BillingDetailsUpdateRequest{}
...
func (o BillingDetailsUpdateRequest) ToMap() (map[string]interface{}, error) {
