...
// checks if the PaymentMethodSnapshot type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentMethodSnapshot{}
...
func (o *PaymentMethodSnapshot) GetPaymentAccountReference() string {
	if o == nil || IsNil(o.PaymentAccountReference.Get()) {
		var ret string
		return ret
	}
...
func (o PaymentMethodSnapshot) ToMap() (map[string]interface{}, error) {
