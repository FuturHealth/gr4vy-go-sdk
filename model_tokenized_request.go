...
// checks if the TokenizedRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TokenizedRequest{}
...
type _TokenizedRequest TokenizedRequest
...
func (o TokenizedRequest) ToMap() (map[string]interface{}, error) {
...
func (o *TokenizedRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varTokenizedRequest := _TokenizedRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTokenizedRequest)

	if err != nil {
		return err
	}

	*o = TokenizedRequest(varTokenizedRequest)
