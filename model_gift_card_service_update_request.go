...
// checks if the GiftCardServiceUpdateRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GiftCardServiceUpdateRequest{}
...
type GiftCardServiceUpdateRequest struct {
	...
	Fields []GiftCardServiceUpdateRequestFieldsInner `json:"fields,omitempty"`
...
func (o *GiftCardServiceUpdateRequest) GetFields() []GiftCardServiceUpdateRequestFieldsInner {
	if o == nil || IsNil(o.Fields) {
		var ret []GiftCardServiceUpdateRequestFieldsInner
		return ret
	}
	return o.Fields
}
...
// SetFields gets a reference to the given []GiftCardServiceUpdateRequestFieldsInner and assigns it to the Fields field.
...
func (o GiftCardServiceUpdateRequest) ToMap() (map[string]interface{}, error) {
