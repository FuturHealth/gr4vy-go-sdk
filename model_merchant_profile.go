...
// checks if the MerchantProfile type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantProfile{}
...
func (o MerchantProfile) ToMap() (map[string]interface{}, error) {
