...
// checks if the ConnectionOptionsCybersourceCard type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectionOptionsCybersourceCard{}
...
func (o ConnectionOptionsCybersourceCard) ToMap() (map[string]interface{}, error) {
