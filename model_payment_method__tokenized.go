...
// checks if the PaymentMethodTokenized type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentMethodTokenized{}
...
func (o *PaymentMethodTokenized) GetApprovalTarget() string {
	if o == nil || IsNil(o.ApprovalTarget.Get()) {
		var ret string
		return ret
	}
...
func (o *PaymentMethodTokenized) GetApprovalUrl() string {
	if o == nil || IsNil(o.ApprovalUrl.Get()) {
		var ret string
		return ret
	}
...
func (o *PaymentMethodTokenized) GetLastReplacedAt() time.Time {
	if o == nil || IsNil(o.LastReplacedAt.Get()) {
		var ret time.Time
		return ret
	}
...
func (o *PaymentMethodTokenized) GetHasReplacement() bool {
	if o == nil || IsNil(o.HasReplacement) {
		var ret bool
		return ret
	}
...
func (o *PaymentMethodTokenized) GetCitLastUsedAt() time.Time {
	if o == nil || IsNil(o.CitLastUsedAt.Get()) {
		var ret time.Time
		return ret
	}
...
func (o *PaymentMethodTokenized) GetCitUsageCount() int32 {
	if o == nil || IsNil(o.CitUsageCount) {
		var ret int32
		return ret
	}
...
func (o PaymentMethodTokenized) ToMap() (map[string]interface{}, error) {
