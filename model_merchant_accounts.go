...
// checks if the MerchantAccounts type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantAccounts{}
...
func (o MerchantAccounts) ToMap() (map[string]interface{}, error) {
