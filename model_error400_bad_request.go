...
// checks if the Error400BadRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Error400BadRequest{}
...
func (o Error400BadRequest) ToMap() (map[string]interface{}, error) {
