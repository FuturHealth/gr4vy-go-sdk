...
// checks if the ThreeDSecureAuthenticationRequestEventContext type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ThreeDSecureAuthenticationRequestEventContext{}
...
func (o ThreeDSecureAuthenticationRequestEventContext) ToMap() (map[string]interface{}, error) {
