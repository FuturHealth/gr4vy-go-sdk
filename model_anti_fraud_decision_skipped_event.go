...
// checks if the AntiFraudDecisionSkippedEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AntiFraudDecisionSkippedEvent{}
...
func (o AntiFraudDecisionSkippedEvent) ToMap() (map[string]interface{}, error) {
