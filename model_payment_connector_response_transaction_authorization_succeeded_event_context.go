...
// checks if the PaymentConnectorResponseTransactionAuthorizationSucceededEventContext type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentConnectorResponseTransactionAuthorizationSucceededEventContext{}
...
func (o *PaymentConnectorResponseTransactionAuthorizationSucceededEventContext) GetRetryRule() string {
	if o == nil || IsNil(o.RetryRule.Get()) {
		var ret string
		return ret
	}
...
func (o PaymentConnectorResponseTransactionAuthorizationSucceededEventContext) ToMap() (map[string]interface{}, error) {
