...
// checks if the StatementDescriptor type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StatementDescriptor{}
...
func (o StatementDescriptor) ToMap() (map[string]interface{}, error) {
