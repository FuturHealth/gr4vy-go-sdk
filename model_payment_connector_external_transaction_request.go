...
// checks if the PaymentConnectorExternalTransactionRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentConnectorExternalTransactionRequest{}
...
func (o PaymentConnectorExternalTransactionRequest) ToMap() (map[string]interface{}, error) {
