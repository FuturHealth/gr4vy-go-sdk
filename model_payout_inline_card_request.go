...
// checks if the PayoutInlineCardRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PayoutInlineCardRequest{}
...
type _PayoutInlineCardRequest PayoutInlineCardRequest
...
func (o PayoutInlineCardRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PayoutInlineCardRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPayoutInlineCardRequest := _PayoutInlineCardRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPayoutInlineCardRequest)

	if err != nil {
		return err
	}

	*o = PayoutInlineCardRequest(varPayoutInlineCardRequest)
