...
// checks if the DigitalWalletClickToPayFields type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DigitalWalletClickToPayFields{}
...
func (o *DigitalWalletClickToPayFields) GetDigitalPaymentApplicationId() string {
	if o == nil || IsNil(o.DigitalPaymentApplicationId) {
		var ret string
		return ret
	}
...
func (o *DigitalWalletClickToPayFields) GetDigitalPaymentApplicationName() string {
	if o == nil || IsNil(o.DigitalPaymentApplicationName) {
		var ret string
		return ret
	}
...
func (o DigitalWalletClickToPayFields) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.DigitalPaymentApplicationId) {
		toSerialize["digital_payment_application_id"] = o.DigitalPaymentApplicationId
	}
	if !IsNil(o.DigitalPaymentApplicationName) {
