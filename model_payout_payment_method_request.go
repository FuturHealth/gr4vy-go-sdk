...
// checks if the PayoutPaymentMethodRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PayoutPaymentMethodRequest{}
...
type PayoutPaymentMethodRequest struct {
	...
	ExpirationDate NullableString `json:"expiration_date,omitempty" validate:"regexp=^\\\\d{2}\\/\\\\d{2}$"`
...
type _PayoutPaymentMethodRequest PayoutPaymentMethodRequest
...
func (o PayoutPaymentMethodRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PayoutPaymentMethodRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPayoutPaymentMethodRequest := _PayoutPaymentMethodRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPayoutPaymentMethodRequest)

	if err != nil {
		return err
	}

	*o = PayoutPaymentMethodRequest(varPayoutPaymentMethodRequest)
