...
// checks if the DigitalWalletGooglePayTokenDecrypted type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DigitalWalletGooglePayTokenDecrypted{}
...
func (o DigitalWalletGooglePayTokenDecrypted) ToMap() (map[string]interface{}, error) {
