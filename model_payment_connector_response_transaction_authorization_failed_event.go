...
// checks if the PaymentConnectorResponseTransactionAuthorizationFailedEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentConnectorResponseTransactionAuthorizationFailedEvent{}
...
func (o PaymentConnectorResponseTransactionAuthorizationFailedEvent) ToMap() (map[string]interface{}, error) {
