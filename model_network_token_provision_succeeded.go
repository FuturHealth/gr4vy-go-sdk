...
// checks if the NetworkTokenProvisionSucceeded type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkTokenProvisionSucceeded{}
...
func (o NetworkTokenProvisionSucceeded) ToMap() (map[string]interface{}, error) {
