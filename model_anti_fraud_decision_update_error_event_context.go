...
// checks if the AntiFraudDecisionUpdateErrorEventContext type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AntiFraudDecisionUpdateErrorEventContext{}
...
func (o AntiFraudDecisionUpdateErrorEventContext) ToMap() (map[string]interface{}, error) {
