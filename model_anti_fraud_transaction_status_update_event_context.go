...
// checks if the AntiFraudTransactionStatusUpdateEventContext type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AntiFraudTransactionStatusUpdateEventContext{}
...
func (o AntiFraudTransactionStatusUpdateEventContext) ToMap() (map[string]interface{}, error) {
