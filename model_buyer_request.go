...
// checks if the BuyerRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BuyerRequest{}
...
func (o BuyerRequest) ToMap() (map[string]interface{}, error) {
