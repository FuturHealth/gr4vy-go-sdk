...
// checks if the ConnectionOptionsAdyenSepa type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectionOptionsAdyenSepa{}
...
func (o *ConnectionOptionsAdyenSepa) GetAutoRescueSepaScenario() string {
	if o == nil || IsNil(o.AutoRescueSepaScenario.Get()) {
		var ret string
		return ret
	}
...
func (o ConnectionOptionsAdyenSepa) ToMap() (map[string]interface{}, error) {
