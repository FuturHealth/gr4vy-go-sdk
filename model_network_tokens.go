...
// checks if the NetworkTokens type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkTokens{}
...
func (o NetworkTokens) ToMap() (map[string]interface{}, error) {
